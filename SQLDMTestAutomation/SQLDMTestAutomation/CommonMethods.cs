...
namespace SQLDMTestAutomation
{
    ...
    public static class CommonMethods
    {
        ...
        [UserCodeMethod]
 		public static void ExcludeDMQ()
        {
        	var repo = SQLDMTestAutomationRepository.Instance;
			var chkExcludeDMQ = repo.AdvancedQueryFilterConfigurationDialog.ChkExcludeDMQ;

   		
        	if (chkExcludeDMQ.Checked) 
        	{
        		chkExcludeDMQ.Checked = false;	
        	}
