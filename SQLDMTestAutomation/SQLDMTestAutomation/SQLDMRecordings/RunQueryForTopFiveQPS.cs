...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The RunQueryForTopFiveQPS recording.
    /// </summary>
    [TestModule("81852640-0a4c-49ab-b891-8dd68a6134f2", ModuleType.Recording, 1)]
    public partial class RunQueryForTopFiveQPS : ITestModule
    {
        /// <summary>
        ...
        static RunQueryForTopFiveQPS instance = new RunQueryForTopFiveQPS();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public RunQueryForTopFiveQPS()
        {
        }
        ...
        /// </summary>
        public static RunQueryForTopFiveQPS Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'select PlanID from QueryMonitorStatistics where SQLServerID = '14' and PlanID IS NOT NULL order by DurationMilliseconds' with focus on 'SSMS.MicrosoftSQLServerManagementStudio.QueryEditor'.", repo.SSMS.MicrosoftSQLServerManagementStudio.QueryEditorInfo, new RecordItemIndex(1));
            repo.SSMS.MicrosoftSQLServerManagementStudio.QueryEditor.PressKeys("select PlanID from QueryMonitorStatistics where SQLServerID = '14' and PlanID IS NOT NULL order by DurationMilliseconds");
