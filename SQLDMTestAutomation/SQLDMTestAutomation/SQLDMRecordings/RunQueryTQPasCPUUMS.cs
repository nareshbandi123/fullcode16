...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The RunQueryTQPasCPUUMS recording.
    /// </summary>
    [TestModule("79752417-77c5-4441-a8e4-08d6a5fb4646", ModuleType.Recording, 1)]
    public partial class RunQueryTQPasCPUUMS : ITestModule
    {
        /// <summary>
        ...
        static RunQueryTQPasCPUUMS instance = new RunQueryTQPasCPUUMS();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public RunQueryTQPasCPUUMS()
        {
        }
        ...
        /// </summary>
        public static RunQueryTQPasCPUUMS Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'select PlanID from QueryMonitorStatistics where SQLServerID = '14' and PlanID IS NOT NULL order by CPUMilliseconds DESC' with focus on 'SSMS.MicrosoftSQLServerManagementStudio.QueryEditor'.", repo.SSMS.MicrosoftSQLServerManagementStudio.QueryEditorInfo, new RecordItemIndex(1));
            repo.SSMS.MicrosoftSQLServerManagementStudio.QueryEditor.PressKeys("select PlanID from QueryMonitorStatistics where SQLServerID = '14' and PlanID IS NOT NULL order by CPUMilliseconds DESC");
