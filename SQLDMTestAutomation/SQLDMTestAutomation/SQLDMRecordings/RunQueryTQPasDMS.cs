...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The RunQueryTQPasDMS recording.
    /// </summary>
    [TestModule("0cc6463d-d666-4b09-805a-0029ffa51c53", ModuleType.Recording, 1)]
    public partial class RunQueryTQPasDMS : ITestModule
    {
        /// <summary>
        ...
        static RunQueryTQPasDMS instance = new RunQueryTQPasDMS();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public RunQueryTQPasDMS()
        {
        }
        ...
        /// </summary>
        public static RunQueryTQPasDMS Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'select PlanID from QueryMonitorStatistics where SQLServerID = '14' and PlanID IS NOT NULL order by DurationMilliseconds DESC' with focus on 'SSMS.MicrosoftSQLServerManagementStudio.QueryEditor'.", repo.SSMS.MicrosoftSQLServerManagementStudio.QueryEditorInfo, new RecordItemIndex(1));
            repo.SSMS.MicrosoftSQLServerManagementStudio.QueryEditor.PressKeys("select PlanID from QueryMonitorStatistics where SQLServerID = '14' and PlanID IS NOT NULL order by DurationMilliseconds DESC");
