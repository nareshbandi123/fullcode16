...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The RunQueryTQPasLDR recording.
    /// </summary>
    [TestModule("a0266f2e-a2f0-4fb6-bb0c-03c1ddd77bd6", ModuleType.Recording, 1)]
    public partial class RunQueryTQPasLDR : ITestModule
    {
        /// <summary>
        ...
        static RunQueryTQPasLDR instance = new RunQueryTQPasLDR();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public RunQueryTQPasLDR()
        {
        }
        ...
        /// </summary>
        public static RunQueryTQPasLDR Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'select PlanID from QueryMonitorStatistics where SQLServerID = '14' and PlanID IS NOT NULL order by  Reads DESC' with focus on 'SSMS.MicrosoftSQLServerManagementStudio.QueryEditor'.", repo.SSMS.MicrosoftSQLServerManagementStudio.QueryEditorInfo, new RecordItemIndex(1));
            repo.SSMS.MicrosoftSQLServerManagementStudio.QueryEditor.PressKeys("select PlanID from QueryMonitorStatistics where SQLServerID = '14' and PlanID IS NOT NULL order by  Reads DESC");
