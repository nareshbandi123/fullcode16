...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The RunQueryTQPasPDW recording.
    /// </summary>
    [TestModule("ab21132f-7fbb-4ed5-a805-8d7104d656fa", ModuleType.Recording, 1)]
    public partial class RunQueryTQPasPDW : ITestModule
    {
        /// <summary>
        ...
        static RunQueryTQPasPDW instance = new RunQueryTQPasPDW();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public RunQueryTQPasPDW()
        {
        }
        ...
        /// </summary>
        public static RunQueryTQPasPDW Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'select PlanID from QueryMonitorStatistics where SQLServerID = '14' order by Writes DESC' with focus on 'SSMS.MicrosoftSQLServerManagementStudio.QueryEditor'.", repo.SSMS.MicrosoftSQLServerManagementStudio.QueryEditorInfo, new RecordItemIndex(1));
            repo.SSMS.MicrosoftSQLServerManagementStudio.QueryEditor.PressKeys("select PlanID from QueryMonitorStatistics where SQLServerID = '14' order by Writes DESC");
